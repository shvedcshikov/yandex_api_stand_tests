...
def positive_assert(first_name):
    ...
    users_table_response = sender_stand_request.qet_users_table()
...
# Функция для негативной проверки с пустым именем
